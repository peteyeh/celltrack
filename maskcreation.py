...
def get_mask_image(image, mask_params='params_gray_mask.yml', verbosity=0):
...
def get_mask_image_with_refined_offset(image, mask_params='params_gray_mask.yml', left=5, right=5):
